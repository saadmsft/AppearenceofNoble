...
export function TopicJourney(props: JourneyProps) {
  ...
  return <div className="topic-journey">
    <header className="journey-intro page-width">
      <h2 id="journey-heading" tabIndex={-1}>{t('journeyTitle')}</h2>
...
function JourneyChapter({ chapter, next, language, paused, readerOpen, savedIds, onPause, onSave, onRead }: JourneyProps & { chapter: Chapter; next?: Chapter }) {
